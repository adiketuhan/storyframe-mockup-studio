  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 space-y-3">
        ...
        {/* Photo Upload */}
        <div>
          <label className="block text-xs text-slate-400 mb-1.5">Foto Utama Feed</label>
          <div className="flex items-center space-x-2">
            ...
            <label className="flex-1 cursor-pointer">
              <div className="py-2 px-3 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl text-xs text-slate-300 font-medium flex items-center justify-center space-x-1.5">
                ...
                <span>Upload Foto Feed Utama</span>
              </div>
              <input
                type="file"
                accept="image/*"
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 bg-slate-950 border border-slate-700 rounded-xl text-sm text-slate-200 focus:outline-none focus:border-rose-500"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 pt-1">
          <div>
            <label className="block text-xs text-slate-400 mb-1">Jumlah Likes</label>
            <input
              type="text"
